...
public class OI {
	...
	public static final int JOYSTICK_GRIP_OPEN = 10;
	public static final int JOYSTICK_GYRO_READ = 11;
	...
	private OI() {
		...
		JoystickButton resetGyro = new JoystickButton(driveController, 
				JOYSTICK_GYRO_RESET);
		JoystickButton readGyro = new JoystickButton(driveController,
				JOYSTICK_GYRO_READ);
		...
		gripCloseContainer.whenPressed(new GripCloseContainer());	//The code errors at this line
		gripCloseTote.whenPressed(new GripCloseTote());
		gripOpen.whenPressed(new GripOpen());
		
		resetGyro.whenPressed(new ResetGyro());
		readGyro.whileHeld(new ReadGyro());
	}
